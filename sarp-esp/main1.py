...
def stopfunc_duration(duration):
    start_time = time.time()
    def stop():
        return time.time() - start_time > duration
    return stop

stopfunc = stopfunc_duration(10)
...
imu._accel.calibrate(stopfunc)
imu._gyro.calibrate(stopfunc)
...
while True:
    ...
    print("i "+ "1 " + "ax:" + str(ax) + " " + "ay:" + str(ay) + " " + "az:" + str(az) + " "+ "gx:" + str(gx*3.1415/180) + " "+ "gy:" + str(gy*3.1415/180) + " "+ "gz:" + str(gz*3.1415/180))
